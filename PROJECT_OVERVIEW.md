...
- ✅ `src/mask_3d.py` — Phase 4 Part 02: paper #12 six-effect qualitative Mask 3D stub + boundary-corrected complex mask fields
...
- ✅ `tests/phase4_m3d_6effects.py` — Phase 4 paper #12 six-effect qualitative + field boundary-correction tests
...
- ✅ `data/absorber_nk/materials.json` — starter absorber n,k data for paper #7/#17 qualitative screening
...
- ✅ `docs/phase4_M3D_design.md` — Phase 4 reduced Mask 3D boundary correction assumptions and limits
...
### Step 2 — Phase 4 absorber-data refinement
- Replace starter absorber values with measured n,k data before quantitative absorber screening.
- Add lookup-table hooks for rigorous Mask 3D data once available.
...
자산 (현재):
  ...
  ✅ Phase 4 paper #12 six-effect stub + field boundary correction started
  ✅ Tier 1 matplotlib 3D notebooks added
  ⏳ Open Access PDF 다운로드 (사용자 수동)

다음 단계:
  1. Phase 4 measured absorber n,k / lookup-table refinement
