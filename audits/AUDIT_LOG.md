...
추세 (5-point established: EXT-AUD-001 → 002 → 003 → 004 → 005):
  ...
  단위 테스트 수:       5 → 9 → 14 → 20 → 25 → 32 → 38 → 42 → 48 → 52 → 58 → 61 → 64 → 73 → 79 → 84 → 89 → 98 → 103 → 108 → 113 → 118 (+2260% 누적) ★
  Test pass rate:      5/5 → 9/9 → 14/14 → 20/20 → 25/25 → 32/32 → 38/38 → 42/42 → 48/48 → 52/52 → 58/58 → 61/61 → 64/64 → 73/73 → 79/79 → 84/84 → 89/89 → 98/98 → 103/103 → 108/108 → 113/113 → 118/118 (100% 유지)
  ...
  KPI K5 (SMO):        pending → source-mask-dose grid-search MVP + LWR objective → PMWO/OPC + 2-D EPE maps → ILT finite-difference + full-layout contour EPE → assist-feature OPC + pixel-level ILT ★
  KPI 평균 진척률:      33% → 33% → 33%+ → 42% → 50% → 58% → 61% → 63% → 65% → 67% → 70% → 72% → 75% → 78% → 82% → 86% → 90% → 93%
  누적 단순화:          7 → 7 → 11 → 14 → 16 → 18 (P6-L9/L10 신규)
