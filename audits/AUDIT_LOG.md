...
추세 (4-point established: EXT-AUD-001 → 002 → 003 → 004):
  ...
  단위 테스트 수:       5 → 9 → 14 → 20 → 25 → 32 → 38 → 42 → 48 → 52 → 58 (+1060% 누적) ★
  Test pass rate:      5/5 → 9/9 → 14/14 → 20/20 → 25/25 → 32/32 → 38/38 → 42/42 → 48/48 → 52/52 → 58/58 (100% 유지)
  KPI K3 (DOF 정량):   0% → 0% → enabled → 50% → 100% ★
  KPI K1 (end-to-end): optical only → full MVP ★
  KPI 평균 진척률:      33% → 33% → 33%+ → 42% → 50% → 58% → 61% → 63% → 65% → 67% → 70%
