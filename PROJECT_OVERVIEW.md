...
- ✅ `src/resist_threshold.py`, `src/resist_blur.py`, `src/metrics.py` — Phase 5 MVP/L1 threshold + Gaussian blur + CD/EPE metrics
- ⏳ `src/` (Phase 2–6) — `illuminator.py`, `mask_3d.py`, `resist_depth.py`, `resist_stochastic.py`, `smo.py`, `pmwo.py`
...
- ✅ `tests/phase5_threshold.py`, `tests/phase5_blur.py`, `tests/integration_end_to_end.py` — threshold/blur resist + end-to-end tests
- ⏳ `tests/` (Phase 2–6) — 후속 정밀화 단위 테스트
- ✅ `notebooks/0_first_aerial_image.ipynb` — Phase 1 데모
- ✅ `notebooks/4a_threshold_resist.ipynb`, `notebooks/4b_resist_levels.ipynb` — Phase 5 threshold/blur 데모
