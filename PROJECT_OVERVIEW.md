...
- ✅ `notebooks/3d_focus_stack.ipynb`, `notebooks/3d_pupil_wavefront.ipynb`, `notebooks/3d_resist_depth.ipynb` — Tier 1 matplotlib 3D visualizations
...
자산 (현재):
  ...
  ✅ Tier 1 matplotlib 3D notebooks added
