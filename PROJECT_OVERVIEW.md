...
- ⏳ `src/` (Phase 6 follow-up) — `opc.py`, assist-feature candidates, and continuous/pixel-level ILT backends
...
- ⏳ `tests/` (Phase 6 follow-up) — assist-feature and pixel-level ILT tests
...
- ✅ `notebooks/5_SMO_PMWO.ipynb` — Phase 6 SMO/PMWO/ILT candidate ranking and optimized print comparison
...
- ✅ `docs/phase6_optimization_design.md` — Phase 6 SMO/PMWO/ILT objective, OPC candidates, contour EPE maps, and simplifications
- ✅ `docs/study_grade_relaxation.md` — study-purpose strictness and audit severity policy
- ⏳ `docs/` (Phase 6 API/refinement) — OPC assist-feature follow-up docs
...
### Step 3 — Phase 6 assist-feature and continuous ILT refinement
- Extend the scalar finite-difference ILT loop to assist-feature and pixel-level candidate families.
- Add polygon contour extraction and larger source/pupil/wavefront sweeps.
...
자산 (현재):
  ...
  ✅ Simulator code Phase 1/2/3/5/6 Part 03 implemented
...
다음 단계:
  1. Phase 6 Part 04 assist-feature OPC and pixel-level ILT refinement
